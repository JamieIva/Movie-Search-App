...
export default function HomePage() {
  ...
  //modal creation on thoughts on quote 
  ...
  ,[])
    ...
    return ( 
        <>
            <div className="feedback-overlay hide">
              <div className="feedback-container">
                ...
                <div className="feedback-right">
                  ...
                  <div className="form-btn" onClick={openModal}>
              ...
              <div className="main-section">
                ...
                <div className="childs">
                  <div className="card0">
                    ...
                    <div className="foot" onClick={openModal}>
                        <span>Join UYATMR Mailing List</span>
                    </div>
                  </div>
                  <div className="card1">
                    <div className="caption">
                    ...
                    <div className="foot">
                      <a href="#">
                        <span>Join iMarketer Waiting List</span>
                      </a>
                    </div>
                  </div>
                  <div className="card0">
                    ...
                    <div className="foot">
                      <a href="#">
                        <span>Join iPartner Mailing List</span>
                      </a>
                    </div>
                  </div>
                </div>
